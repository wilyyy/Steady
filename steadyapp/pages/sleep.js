...
export default function Title(){
    ...
    return <TitleContainer>
        ...
        <div className="column">
            ...
            <BoxyButton display="none" layout="center" position="static" text="<7 Hours" onClick={()=>HandleClick1("TooLittle")}
            bgcolor={picstate1 ? "#F57C33" : "#E8E0CD"}
            textcolor = {picstate1 ? "white" : "#131521"} />
            <BoxyButton display="none" layout="center" position="static" text="7-9 Hours" onClick={()=>HandleClick2("Perfect")}
            bgcolor={picstate2 ? "#F57C33" : "#E8E0CD"}
            textcolor = {picstate2 ? "white" : "#131521"} />
            <BoxyButton display="none" layout="center" position="static" text="9+ Hours" onClick={()=>HandleClick3("TooMuch")}
