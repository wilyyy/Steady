...
export default function Title(){
    ...
    return <TitleContainer>
        ...
        <div className="column">
            ...
            <BoxyButton display="none" layout="center" position="static" text="<3 Meals" onClick={HandleClick1}
            bgcolor={picstate1 ? "#F57C33" : "#E8E0CD"}
            textcolor = {picstate1 ? "white" : "#131521"} />
            <BoxyButton display="none" layout="center" position="static" text="3-4 Meals" onClick={HandleClick2}
            bgcolor={picstate2 ? "#F57C33" : "#E8E0CD"}
            textcolor = {picstate2 ? "white" : "#131521"} />
            <BoxyButton display="none" layout="center" position="static" text="4+ meals" onClick={HandleClick3}
