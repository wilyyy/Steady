...
export default function Title(){
    ...
    const HandleEnd = () => {
        alert(result);
        sessionStorage.setItem("mealresult", result);
    ...
    return <TitleContainer>
        ...
        <div className="column">
            <TopBar />
            <Combo src="/meal_icon.png" subtitle1="" title1="How many meals do you eat in a day?" width="150px"/>
            <BoxyButton display="none" layout="center" position="static" text="<3 Meals" onClick={()=>HandleClick1("TooLittle")}
            bgcolor={picstate1 ? "#F57C33" : "#E8E0CD"}
            textcolor = {picstate1 ? "white" : "#131521"} />
            <BoxyButton display="none" layout="center" position="static" text="3-4 Meals" onClick={()=>HandleClick2("Perfect")}
            bgcolor={picstate2 ? "#F57C33" : "#E8E0CD"}
            textcolor = {picstate2 ? "white" : "#131521"} />
            <BoxyButton display="none" layout="center" position="static" text="4+ meals" onClick={()=>HandleClick3("TooMuch")}
