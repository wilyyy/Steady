...
const FullResource = ({
    ...
    return <Container>
        ...
        <br />
        <ResourceContainer>Here you can find out about good sleeping h in general. What it consists of, the differents disorders, and also some solutions to them.</ResourceContainer>
        <img src={MiniPic}/>
        <Link href=https://www.sutterhealth.org/health/nutrition/eating-well-for-mental-health#:~:text=To%20boost%20your%20mental%20health,are%20also%20excellent%20brain%20foods.>Click Here to read more!</Link>
        <br />
