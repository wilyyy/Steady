...
const FullResource = ({
    ...
    return <Container>
        ...
        <br />
        <ResourceContainer>Here you can find out about Mental Health in general. What it consists of, the differents disorders, and also some solutions to them.</ResourceContainer>
        <img src={MiniPic}/>
        <Link href={ResourceLink}>Click Here to read more!</Link>
        <br />
