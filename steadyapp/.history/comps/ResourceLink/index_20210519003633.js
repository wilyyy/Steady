...
const FullResource = ({
    ...
    return <Container>
        <ResourceHeader>https://www.healthline.com/nutrition/17-tips-to-sleep-better</ResourceHeader>
        <img src={MiniPic}/>
        <Link href={ResourceLink}>Click Here to read more!</Link>
        <br />
        <ResourceContainer>Here you can find out about good sleeping habits in general. What it consists of, the differents disorders, and also some solutions to them.</ResourceContainer>
        <img src={MiniPic}/>
        <Link href={ResourceLink}>Click Here to read more!</Link>
        <br />
