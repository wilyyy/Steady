...
export default function Title(){
    return <ResultsContainer>
        ...
        <div className="column">
            <Logo wide="100px" />
            <Combo title1="Results..." headsize="5rem" textsize="0.5rem" subtitle1="You are doing..." />
            <Combo title1="Not so great" headsize="4.5rem" textsize="0.5rem" subtitle1="It seems you're having a bad time on all fronts. This is a great time to take a moment and breathe. Think to yourself what steps you can take to bring your life to a better direction. Don't hesitate to click the button for more info." textsize="2rem" />
