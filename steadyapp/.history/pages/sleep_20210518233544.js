...
export default function Title(){
    ...
    return <TitleContainer>
        ...
        <div className="column">
            ...
            <BoxyButton display="none" layout="center" position="static" text="<4-7 Hours" onClick={HandleClick1}
            ...
            <BoxyButton display="none" layout="center" position="static" text="13-15 Hours" onClick={HandleClick3}
