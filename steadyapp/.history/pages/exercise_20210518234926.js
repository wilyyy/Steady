...
export default function Title(){
    ...
    return <TitleContainer>
        ...
        <div className="column">
            <TopBar />
            <Combo src="/scale.png" subtitle1="" title1="How often do you exercise?" width="150px"/>
            <BoxyButton display="none" layout="center" position="static" text="<5 Hours/Week" onClick={HandleClick1}
            bgcolor={picstate1 ? "#F57C33" : "#E8E0CD"}
            textcolor = {picstate1 ? "white" : "#131521"} />
            <BoxyButton display="none" layout="center" position="static" text="5-12 Hours/Week" onClick={HandleClick2}
            bgcolor={picstate2 ? "#F57C33" : "#E8E0CD"}
            textcolor = {picstate2 ? "white" : "#131521"} />
            <BoxyButton display="none" layout="center" position="static" text="12+ Hours" onClick={HandleClick3}
