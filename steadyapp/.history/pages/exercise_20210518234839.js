...
export default function Title(){
    ...
    return <TitleContainer>
        ...
        <div className="column">
            ...
            <BoxyButton display="none" layout="center" position="static" text="5-10 Hours/Week" onClick={HandleClick2}
            bgcolor={picstate2 ? "#F57C33" : "#E8E0CD"}
            textcolor = {picstate2 ? "white" : "#131521"} />
            <BoxyButton display="none" layout="center" position="static" text="" onClick={HandleClick3}
