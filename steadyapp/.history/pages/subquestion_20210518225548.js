...
export default function Title(){
    ...
    useEffect(()=>{
        if(process.browser){
            ...
            if(buttontextJSON.text1 === "Meals"){
                setText(SubquestionQ.mealsQ)
            } else if (buttontextJSON.text2 === "Sleep"){
                setText(SubquestionQ.sleepQ)
            } else{
                setText(SubquestionQ.exerciseQ)
            }
        }
    }, []);
    ...
    return <TitleContainer>
        ...
        <div className="column">
            <TopBar />
            <Combo src="/sleep.png" subtitle1="" title1={text} width="150px"/>
