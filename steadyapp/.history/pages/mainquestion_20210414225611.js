...
export default function Title(){
    return <MainQuestionContainer>
        ...
        <div className="column">
            ...
            <Button imageappear="flex" src="../../depression.png" buttontext="Meals" bgcolor= "#F86D34" textcolor="#E8E0CD" bheight="5rem" bwidth="20rem"/>
            <Button imageappear="flex" src="../../depression.png" buttontext="Emotions" bgcolor= "#F86D34" textcolor="#E8E0CD" bheight="5rem" bwidth="20rem"/>
        </div>
