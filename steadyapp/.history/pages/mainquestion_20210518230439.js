...
export default function Title(){
    ...
    const HandleEnd = () =>{
        sessionStorage.setItem("buttontext", JSON.stringify(buttontext));
        router.push("/subquestion");
    }
