...
export default function Title(){
    ...
    return <TitleContainer>
        ...
        <div className="column">
            ...
            <BoxyButton display="none" layout="center" position="static" text="4 to 7 hours or less" onClick={HandleClick1}
            ...
            <BoxyButton display="none" layout="center" position="static" text="9-12 Hours" onClick={HandleClick3}
